// ip4kmainpluscopro.cxx - ip4k main plus coprocessor sid encapsulation.  -*- C++ -*-
...
ip4k_main_plus_copro::ip4k_main_plus_copro (const string& conf_file_name) :
  simwcpu (conf_file_name)
{
  ...
  this->timer = lookup_component("ip4ktimer");
  assert(timer !=0);
...
sid::bus::status 
ip4k_main_plus_copro::read_data_memory_main (sid::host_int_4 addr,
					     unsigned int length,
					     sid::host_int_1 *buf)
{
  big_int_1 k;
...
sid::bus::status 
ip4k_main_plus_copro::write_data_memory_main (sid::host_int_4 addr,
					      unsigned int length,
					      sid::host_int_1 *buf)
{
  big_int_1 k;
...
sid::bus::status 
ip4k_main_plus_copro::read_insn_memory_main (sid::host_int_4 addr,
					     unsigned int length,
					     sid::host_int_1 *buf)
{
  big_int_1 k;
...
sid::bus::status 
ip4k_main_plus_copro::write_insn_memory_main (sid::host_int_4 addr,
					      unsigned int length,
					      sid::host_int_1 *buf)
{
  big_int_1 k;
...
sid::bus::status 
ip4k_main_plus_copro::read_data_memory_copro (sid::host_int_4 addr,
					      unsigned int length,
					      sid::host_int_1 *buf)
{
  big_int_1 k;
...
sid::bus::status 
ip4k_main_plus_copro::write_data_memory_copro (sid::host_int_4 addr,
					       unsigned int length,
					       sid::host_int_1 *buf)
{
  big_int_1 k;
...
sid::bus::status 
ip4k_main_plus_copro::read_insn_memory_copro (sid::host_int_4 addr,
					      unsigned int length,
					      sid::host_int_1 *buf)
{
  big_int_1 k;
...
sid::bus::status 
ip4k_main_plus_copro::write_insn_memory_copro (sid::host_int_4 addr,
					       unsigned int length,
					       sid::host_int_1 *buf)
{
  big_int_1 k;
...
ip4k_main_plus_copro::read_register_main (ip4kcpu::regno_t regno,
...
sid::component::status 
ip4k_main_plus_copro::read_register_main (int context,
...
sid::component::status 
ip4k_main_plus_copro::write_register_main (ip4kcpu::regno_t regno,
					   sid::host_int_4 value)
{
  this->check_load ();
  string regname;
...
sid::component::status 
ip4k_main_plus_copro::write_register_main (int context,
					   ip4kcpu::regno_t regno,
					   sid::host_int_4 value)
{
  this->check_load ();
...
sid::component::status 
ip4k_main_plus_copro::read_register_copro (ip4kcopro::regno_t regno,
...
sid::component::status 
ip4k_main_plus_copro::write_register_copro (ip4kcopro::regno_t regno,
					    sid::host_int_8 value)
{
  this->check_load ();
  string regname = string("gdb-register-") + sidutil::make_numeric_attribute (regno);
...
sid::component::status
ip4k_main_plus_copro::interrupt_main (unsigned irq_num)
{
...
void
ip4k_main_plus_copro::checkpoint_all_state (std::ostream& file)
{
...
sid::component::status
ip4k_main_plus_copro::restore_all_state (std::istream& file)
{
...
sid::component::status
ip4k_main_plus_copro::read_all_timer_registers(host_int_4 *buf)
{
  string sys_value;
  if(timer == NULL)
    return sid::component::not_found;
...
sid::component::status
ip4k_main_plus_copro::write_all_timer_registers(host_int_4 *buf)
{
  for(int i=0; ; i++)
    {
      if(timerRegNames[i] == 0)
...
sid::component::status
ip4k_main_plus_copro::tick_mpt_clock(void)
{
...
sid::component::status
ip4k_main_plus_copro::tick_sys_clock(void)
{
...
void
ip4k_main_plus_copro::execute_main()
{
  // kick the pin
...
void
ip4k_main_plus_copro::execute_copro()
{
  // kick the pin
