/* ip4kcopro sid encapsulation library test case 5
# mach(): ip4k
...
int main()
{
  ...
  ip4kcopro *mycpu2 = new ip4kcopro();
  mycpu2->load ("ip4kcopro.out");
  mycpu2->step (3);
  mycpu2->read_register (ip4kcopro::r3, r3);
  CHECK(r3 == 12);
  mycpu2->read_register (ip4kcopro::pc, pc);
  CHECK(pc == 24);
  // save msg pointer for later
  mycpu2->read_register (ip4kcopro::r2, r2);

  r3 = 0;
  ip4kcopro *mycpu3 = new ip4kcopro();
  mycpu3->load ("ip4kcopro.out");
  mycpu3->step (2);
  mycpu3->read_register (ip4kcopro::r3, r3);
  CHECK(r3 == 12);
  mycpu3->read_register (ip4kcopro::pc, pc);
  CHECK(pc == 16);
  ...
  mycpu2->read_register (ip4kcopro::r3, r3);
  CHECK(r3 == 12)
  mycpu2->write_register (ip4kcopro::r3, 0);
  mycpu2->read_register (ip4kcopro::pc, pc);
  CHECK(pc == 24);
  mycpu2->write_register (ip4kcopro::pc, 0);
