/* ip4kcopro sid encapsulation library test case 1
# mach(): ip4k
...
int main()
{
  ...
  CHECK(mycpu->set_attribute ("cpu", "r8", "5") ==
	component::ok);
  mycpu->read_register (ip4kcopro::r8, r8);
  CHECK(r8 == 5);
  ...
  r3 = 44;
  mycpu->write_register (ip4kcopro::r3, r3);
  mycpu->read_register (ip4kcopro::r3, r3);
  CHECK(r3 == 44)
  ...
  mycpu->read_register (ip4kcopro::r3, r3);
  CHECK(r3 == 44)
  mycpu->write_register (ip4kcopro::r3, 0);

  mycpu->read_register (ip4kcopro::pc, pc);
  CHECK(pc == 24);
  mycpu->write_register (ip4kcopro::pc, 0);
