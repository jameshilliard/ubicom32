/* ip4k_main_plus_copro sid encapsulation library test case 4
# mach(): ip4k
...
int main()
{
  ...
  ip4k_main_plus_copro *newcpu = new ip4k_main_plus_copro();

  newcpu->load_main ("ip4kmpc_main.out");
  newcpu->load_copro ("ip4kmpc_copro.out");
