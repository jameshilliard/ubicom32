/* ip3kcpu sid encapsulation library test case 5
# mach(): ip3k
...
int main()
{
  ...
  ip3kcpu *mycpu2 = new ip3kcpu();
  mycpu2->load ("ip3kcpu.out");
  mycpu2->step (3);
  mycpu2->read_register (ip3kcpu::d4, d4);
  CHECK(d4 == 12);
  mycpu2->read_register (ip3kcpu::pc, pc);
  CHECK(pc == 12);
  // save msg pointer for later
  mycpu2->read_register (ip3kcpu::d3, d3);

  d4 = 0;
  ip3kcpu *mycpu3 = new ip3kcpu();
  mycpu3->load ("ip3kcpu.out");
  mycpu3->step (2);
  mycpu3->read_register (ip3kcpu::d4, d4);
  CHECK(d4 == 12);
  mycpu3->read_register (ip3kcpu::pc, pc);
  CHECK(pc == 8);
