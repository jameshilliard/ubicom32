...
#endif
#if SIDTARGET_UBICOM32
  types.push_back ("hw-cpu-ubicom32");
  types.push_back ("hw-cpu-ubicom32mars");
  types.push_back ("hw-cpu-ubicom32ares");
  types.push_back ("hw-cpu-ubicom32jupiter");
#endif
  return types;
}
...
#endif
#if SIDTARGET_UBICOM32
  if (typeName == "hw-cpu-ubicom32")
    return new ubicom32bf::ubicom32bf_cpu (0);
  if (typeName == "hw-cpu-ubicom32mars")
    return new ubicom32bf::ubicom32bf_cpu (1);
  if (typeName == "hw-cpu-ubicom32ares")
    return new ubicom32bf::ubicom32bf_cpu (2);
  if (typeName == "hw-cpu-ubicom32jupiter")
    return new ubicom32bf::ubicom32bf_cpu (3);
#endif
