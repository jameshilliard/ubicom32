...
sidtarget_ubicom32=$sidtarget_default
...
AC_MSG_CHECKING(Ubicom Ubicom32 family support)
AC_SUBST(sidtarget_ubicom32)
AM_CONDITIONAL(SIDTARGET_UBICOM32,[test "x$sidtarget_ubicom32" = x1])
AC_MSG_RESULT($sidtarget_ubicom32)
