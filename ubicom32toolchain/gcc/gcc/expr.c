  ...
  if (default_label)
    {
      ...
      /* DJH - for some reason default branches end up predicted taken
         when that really doesn't seem very likely (why write a switch
	 statement for which you don't expect to execute one of the
	 case clauses?  */
