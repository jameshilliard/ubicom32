...
static int arch_numregs=0;		/* This is used to keep track of architecture changes. */
	       ...
	       int objc, Tcl_Obj **objv)
{
  ...
  /* Check if the architecture has changed underneath us. */
  if (numregs != arch_numregs)
    setup_architecture_data();
