...
/* extern functions */
#ifdef __BIG_ENDIAN
#define musb_writew(value, offset) writew(cpu_to_le16(value), offset)
#define musb_writeb(value, offset) writeb(value, offset)
#define musb_readw(offset) cpu_to_le16(readw(offset))
#define musb_readb(offset) readb(offset)
#else
#define musb_writew(value, offset) writew(value, offset)
#define musb_writeb(value, offset) writeb(value, offset)
#define musb_readw(offset) readw(offset)
#define musb_readb(offset) readb(offset)
#endif
