...
#define TR0(fmt, args...) printk("SynopGMAC: " fmt, ##args)

#if 0
#undef TR
# define TR(fmt, args...) printk("SynopGMAC: " fmt, ##args)
#else
...
static void __inline__ plat_free_consistent_dmaable_memory(void *dev, size_t size, void *cpu_addr, dma_addr_t dma_addr)
{
