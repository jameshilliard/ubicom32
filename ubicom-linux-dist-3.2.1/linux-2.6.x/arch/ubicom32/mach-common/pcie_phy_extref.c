...
void __init pcie_phy_config(struct ubicom32_io_port *phy)
{
	...
	phy_writeb(phy, 0x002, 0x00);
	phy_writeb(phy, 0x003, 0xF0);
	phy_writeb(phy, 0x004, 0x00);
	phy_writeb(phy, 0x005, 0x00);
	phy_writeb(phy, 0x006, 0x00);
	...
	phy_writeb(phy, 0x06A, 0x04);
	phy_writeb(phy, 0x06B, 0xE7);
	phy_writeb(phy, 0x06C, 0xA0);
	phy_writeb(phy, 0x06D, 0x02);
	...
	phy_writeb(phy, 0x207, 0x93);
	phy_writeb(phy, 0x208, 0x9F);
	...
	phy_writeb(phy, 0x214, 0x3C);
	phy_writeb(phy, 0x215, 0x20);
	...
	phy_writeb(phy, 0xA0A, 0x92);
	phy_writeb(phy, 0xA0B, 0x63);
