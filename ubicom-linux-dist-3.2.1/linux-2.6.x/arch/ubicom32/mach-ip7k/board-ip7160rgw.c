 ...
 *	8007-0110 UBICOM IP7160 RGW EVAL Rev 1.0
 *
 *	8007-0111 UBICOM IP7160 RGW EVAL Rev 1.1
 *
 *	8007-0112 UBICOM IP7160 RGW EVAL Rev 1.2
 *	With the following optional adapter board:
 *		8007-1410 IP7K RGW LCD Rev 1.0
 *			+ 8007-0920 IP7K LCD Adapter Rev 2.0
 *				+ TFT1N5046E 8-bit SPLIT
 *			+ 8007-0921 IP7K LCD Adapter Rev 2.1
 *				+ TFT1N5046E 8-bit SPLIT
 *
 ...
 */
struct ubicom32fb_platform_data ip7160rgw_ubicom32fb_platform_data __initdata;
 ...
 * Touch controller
 *
 * Connected via I2C bus, interrupt on PA5
 */
...
static int __init ip7160rgw_init(void)
{
	 ...
	 * Bring up lcd
	 */
	vdc_tio_fill_platform_data(&ip7160rgw_ubicom32fb_platform_data);

	printk(KERN_INFO "%s: initializing lcd driver\n", __FUNCTION__);

	vdc_tio_init(&ip7160rgw_ubicom32fb_platform_data);
#endif
