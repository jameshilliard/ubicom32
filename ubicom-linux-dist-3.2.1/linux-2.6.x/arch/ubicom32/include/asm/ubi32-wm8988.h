...
enum ubi32_wm8988_mclk_source {
	UBI32_WM8988_MCLK_PWM_0,
	UBI32_WM8988_MCLK_PWM_1,
	UBI32_WM8988_MCLK_PWM_2,
	UBI32_WM8988_MCLK_CLKDIV_1,
	UBI32_WM8988_MCLK_OTHER,
};

struct ubi32_wm8988_mclk_entry {
	/*
...
struct ubi32_wm8988_platform_data {
	enum ubi32_wm8988_mclk_source	mclk_src;

	int				n_mclk;
	struct ubi32_wm8988_mclk_entry	*mclk_entries;
};
