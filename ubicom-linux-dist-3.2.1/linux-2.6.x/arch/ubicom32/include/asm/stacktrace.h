...
#define STACKTRACE_DEFAULT_PC ((unsigned long)0xffffffff)
...
enum stacktrace_type {
	STACKTRACE_KERNEL,
	STACKTRACE_USER,
};

struct stacktrace_bounds {
	enum stacktrace_type type;
	unsigned long stext;
	unsigned long etext;
...
extern unsigned long stacktrace_iterate(struct task_struct *tsk,
