 ...
 *
 * This sequence gets inlined in "pic_execute_preempt", a piece ofassembly code in
 * arch/ubicom32/kernel/pic.c that is invoked by the pic to preempt a linux thread
 * of execution. This sequence is only needed for the 5k and 7k only.
 *
 */
...
asm (
	...
	"	or.4	D_RANGE3_EN, D_RANGE3_EN, \\thread	\n\t"
	".endm							\n\t"
);
