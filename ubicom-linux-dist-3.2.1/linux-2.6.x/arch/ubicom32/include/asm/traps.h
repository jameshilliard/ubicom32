...
#define TRAP_CAUSE_PRIV_VIOLATION	13
...
extern void die(char *str, struct pt_regs * regs, long trap_cause);
extern void die_if_kernel(char *str, struct pt_regs * regs, long trap_cause);
extern void do_trap(struct pt_regs *regs);
extern int unaligned_emulate(struct pt_regs *regs);
extern int unaligned_only(struct pt_regs *regs);
