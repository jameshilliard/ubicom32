...
#define UBICOM32_FRAME_TYPE_PAGE_FAULT	5 /* Page Fault. */
...
struct pt_regs {
	...
	/*
	 * Place the new regs after the frame type to keep from
	 * recompiling/breaking existing ptrace user code.
	 */
#if defined(IP8000)
	unsigned long int_mask2;
#endif
	...
	unsigned long asid_cmp;
#endif

	/*
	 * Any further new entries shoud be added to the end of this structure
	 */
};
