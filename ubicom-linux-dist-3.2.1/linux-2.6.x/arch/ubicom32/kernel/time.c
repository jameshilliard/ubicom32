...
{
	/*
	 * Reset the timer in the PIC thread to go off appropriately.
	 *
	 ...
	 * timer tick.  We can not fix the time since the modern time
	 * handling uses clock devices and clock events and no longer
	 * uses timer_tick().
	 */
	while (1) {
		/*
