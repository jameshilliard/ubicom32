...
# This module causes wired performance drop
...
# These modules causes wired performance drop
...
ifeq ($(ARCH),ubicom32)
  $(eval $(call nf_add,IPT_IPOPT,CONFIG_IP_NF_MATCH_URLFILTER, $(P_V4)ipt_urlfilter))
endif
...
ifeq ($(ARCH),ubicom32)
  $(eval $(call nf_add,IPT_NAT,CONFIG_IP_NF_TARGET_NATTYPE, $(P_V4)ipt_NATTYPE))
  $(eval $(call nf_add,IPT_NAT,CONFIG_IP_NF_TARGET_PORTTRIGGER, $(P_V4)ipt_PORTTRIGGER))
endif
