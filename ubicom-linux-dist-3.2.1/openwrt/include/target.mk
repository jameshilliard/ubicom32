...
ifeq ($(DUMP),1)
  ...
  DEFAULT_CFLAGS_ubicom32=-Os -pipe -march=ubicom32v5 -DUBICOM32_ARCH_VERSION=5 -DIP8000
  DEFAULT_CFLAGS=$(if $(DEFAULT_CFLAGS_$(ARCH)),$(DEFAULT_CFLAGS_$(ARCH)),-Os -pipe -funit-at-a-time)
  DEFAULT_LDFLAGS_ubicom32=-march=ubicom32v5
  DEFAULT_LDFLAGS=$(if $(DEFAULT_LDFLAGS_$(ARCH)),$(DEFAULT_LDFLAGS_$(ARCH)),)
endif
...
define BuildTargets/DumpCurrent
  ...
  dumpinfo:
	@echo 'Target: $(TARGETID)'; \
	 ...
	 echo 'Target-LinkerFlags: $(if $(LDFLAGS),$(LDFLAGS),$(DEFAULT_LDFLAGS))'; \
