...
fw_start() {
	...
	echo "Loading wan ping"
	fw_config_once fw_load_wan_ping defaults

	echo "Loading remote management"
	fw_config_once fw_load_rmt_mng defaults

	echo "Loading nat type"
	fw_config_once fw_load_nat_type defaults

	echo "Loading porttriggers"
	config_foreach fw_load_porttrigger porttrigger

	echo "Loading virtual services"
	config_foreach fw_load_vservice vservice

	echo "Loading urlfilter"
	fw_config_once fw_load_urlfilter urlfilter

	echo "Loading dmz"
	fw_config_once fw_load_dmz defaults
